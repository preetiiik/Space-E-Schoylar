  ...
  },
{
  ...
  },
  {
    ...
    desc: [
      ...
      "We're developing a Mobile Space Lab: a 40-seat bus fully converted into a moving cosmic classroom, designed for schools and villages that our fixed labs cannot reach. Every surface inside will be built to teach — the ceiling, mapping moon phases, constellations, and satellites, while the walls illustrate eclipses, rocket stages, and orbital paths. Seat-back panels will bring learning to every student with flip charts, QR codes, mini models, and VR space activities. At the rear, a holographic demo zone will let children interact with solar system displays and hands-on experiments — turning every journey into an immersive science experience. ",
